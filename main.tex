...
\begin{titlepage}
	...
	\vspace*{0.5cm} % เพิ่มระยะนุ่มๆ จากขอบบนสุดของกระดาษ
	
	% ===== โลโก้ =====
	\begin{minipage}{0.9\textwidth}
		\centering
		\includegraphics[height=3.2cm]{kku} 
		\hspace{1.5cm} 
		\includegraphics[height=3.2cm]{satitkkunkc.jpg}
	\end{minipage}
	
	\vfill % ใช้ vfill เพื่อให้ระยะห่างระหว่างโลโก้กับกล่องข้อความยืดหยุ่นตามหน้ากระดาษ
	
	% ===== กำหนดสีภายในหน้าปก =====
	\definecolor{coverblue}{rgb}{0.64, 0.76, 0.68}
	\definecolor{covergray}{rgb}{0.2, 0.2, 0.2}
	
	% ===== กล่องหัวเรื่อง (TikZ แถบหนาด้านซ้าย) =====
	\begin{tikzpicture}
		\node[fill=coverblue!20, 
		text width=0.85\textwidth, 
		align=center, 
		inner sep=30pt] (box) {
			{\Huge\bfseries\color{covergray} เอกสารประกอบการสอน}\\[1.2em]
			{\huge\color{covergray} วิชา คณิตศาสตร์}\\[0.8em]
			{\Large\color{covergray!80} หัวข้อ : ทดลองเอกสารมัธยมศึกษาปีที่ 5}
		};
		\draw[coverblue, line width=5pt] (box.north west) -- (box.south west);
	\end{tikzpicture}
	
	\vfill 
	\vfill % ใส่สองตัวเพื่อผลักข้อมูลผู้สอนลงมาอยู่บริเวณช่วงล่างของหน้ากระดาษอย่างสวยงาม
	
	% ===== ข้อมูลผู้สอนและหน่วยงาน =====
	\begin{minipage}{0.9\textwidth}
		\centering
		{\large อาจารย์ผู้สอน}\\[0.5cm]
		{\huge \textbf{ดร. ภาณุวิชญ์ เชื้อพล}}\\[1.0cm]
		{\large กลุ่มสาระการเรียนรู้คณิตศาสตร์}\\[0.3cm]
		{\large โรงเรียนสาธิตมหาวิทยาลัยขอนแก่น วิทยาเขตหนองคาย}
	\end{minipage}
	
	\vspace*{1.5cm} % เว้นระยะปิดท้ายด้านล่างสุดให้สมดุลกับขอบบน
